...
import '../Model/assignment_model/assignmentapi.dart';
                      ...
                      child: Column(
                                          ...
                                          onTap: () {
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        Assignmentdetail(
                                                          jobid: state.assignmentResponse.data[index]
                                                              .jobId,
                                                        )));
                                          },
                                          child: Container(
                                                      ...
                                                      Container(
                                                        child: Column(
                                                          ...
                                                          const  SizedBox(
                                                            ...
                                                            Container(
                                                                child: Text(
                                                                     state.assignmentResponse.data[index].startDate.toString() != null ?
                                                                      DateFormat(state.formateResponse.data[0].currentDateFormat).
                                                                      format(DateTime.parse(state.assignmentResponse.data[index].startDate.toString())) : ' - - - ',
                                                                     style:const TextStyle(
                                                          ...
                                                          child: Column(
                                                           ...
                                                           const   SizedBox(
                                                              ...
                                                              state.assignmentResponse.data[
                                                                      ...
                                                                      null
                                                                  ? Container(
                                                                      child: Text(DateFormat(state.formateResponse.data[0].currentDateFormat).format(DateTime.parse(state.assignmentResponse.data[index].endDate)),
                                                                                  style:const TextStyle(
                                                                                      color: Color.fromRGBO(0, 0, 0, 1),
                                                                                      //fontWeight: FontWeight.w600,
                                                                                      fontWeight: FontWeight.bold,
                                                                                      fontSize: 14.0)))
                                                                  : Container(
                                                                      child: Text(DateFormat(state.formateResponse.data[0].currentDateFormat).format(DateTime.parse(state.assignmentResponse.data[index].jobEndDate)),
                                                                        style:const TextStyle(
                                                                        color: Color.fromRGBO(0, 0, 0, 1),
                                                                        //fontWeight: FontWeight.w600,
                                                                        fontWeight: FontWeight.bold,
                        ...
                        const  SizedBox(
                          ...
                          valueexist == ''
                              ...
                              :const Text('No Upcoming Assignment')
                        ],
                      ),
                    )
          ),
